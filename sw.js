const CACHE_NAME='ops-center-v3-ofp-briefing-i18n-13';
const APP_FILES=['./','./index.html','./manifest.webmanifest','./ops-icon.svg','./data/airports.min.json','./data/aircraft-catalog.js?v=13','./data/i18n.js?v=13','./data/world-land.geojson'];
